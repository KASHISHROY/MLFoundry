        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {recentModels.map((m, i) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    <div style={{ backgroundColor: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.2)' }}
                  ...
                  <div className="flex items-center gap-5">
                    ...
                    <div style={{ color: statusColors[m.status], backgroundColor: `${statusColors[m.status]}15`, border: `1px solid ${statusColors[m.status]}30` }}
          ...
          <div style={{ backgroundColor: '#111827', border: '1px solid #1F2937' }}
            ...
            <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
              <div
                style={{ background: 'linear-gradient(135deg, rgba(59,130,246,0.15), rgba(99,102,241,0.15))', border: '1px solid rgba(99,102,241,0.2)' }}
              ...
              <button style={{ color: '#4B5563' }} className="text-xs mt-3 hover:text-gray-400 transition-all">
                browse marketplace →
              </button>
            </div>
          </div>
